...
# Grid: INK at ~12% alpha as 8-char hex (0x1E = 30/255 ≈ 0.118)
...
# mapped to the nearest Imprint palette members and semantic anchors
...
plot = (
    ...
    + geom_bar(aes(fill="zone"), stat="identity", width=0.65, show_legend=False)
    + geom_text(aes(label="duration_label"), va="bottom", nudge_y=0.8, size=3.5, color=INK)
    ...
    + theme(
        ...
        plot_caption=element_text(color=INK_MUTED, size=7, ha="right"),
