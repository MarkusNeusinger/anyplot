...
// Approximate human autosome lengths in Mb — gives chromosomes realistic
// relative widths along the cumulative genomic-position axis.
const chromLengths = [
  249, 243, 198, 191, 181, 171, 159, 146, 141, 136, 135, 133, 115, 107, 102, 90, 83, 80, 59, 64, 47, 51,
];
const chromNames = chromLengths.map((_, i) => String(i + 1));
...
Highcharts.chart("container", {
  ...
  plotOptions: {
    ...
    scatter: {
      marker: { radius: 2.4, symbol: "circle", states: { hover: { radiusPlus: 2.5 } } },
    },
  },
  series: [
    {
      ...
      data: oddPoints,
      color: Highcharts.color(t.palette[0]).setOpacity(0.75).get(),
    },
    {
      name: "Even chromosomes",
      data: evenPoints,
      color: Highcharts.color(t.palette[2]).setOpacity(0.75).get(),
    },
    {
