...
# Styling — reserve headroom above the axes for the title + legend stack
fig.subplots_adjust(top=0.76, bottom=0.13, left=0.09, right=0.97)
...
# Legend — left-to-right order mirrors bottom-to-top stacking order for easy reading
legend_handles = [
