...
# Title font scaling — base 66 px for the ~67-char mandated title
...
custom_style = Style(
    ...
    # Semantic exception: precipitation first (blue/water), temperature second (red/heat)
    colors=(PRECIP_COLOR, TEMP_COLOR, "#009E73", "#C475FD", "#BD8233", "#2ABCCD", "#954477", "#99B314"),
...
# Y-axis ticks: temperature °C values with corresponding precipitation in mm
chart.y_labels = [0, 10, 20, 30]

# Precipitation series: fill=True → blue area from y=0 up to precip/2 line (humid signal)
chart.add("Precipitation (mm ÷ 2)", precip_scaled, fill=True, stroke_style={"width": 4})

# Temperature series: thick red line overlaid — rises above fill in arid summer months
