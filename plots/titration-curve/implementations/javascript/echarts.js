...
chart.setOption({
    ...
    yAxis: [
        ...
        },
        {
            ...
            nameLocation: "middle",
            nameGap: 60,
            nameTextStyle: { color: t.palette[2], fontSize: 14 },
            min: 0,
            max: 40,
            interval: 10,
            axisLabel: { color: t.inkSoft, fontSize: 13 },
            axisLine: { show: true, lineStyle: { color: t.palette[2] } },
            axisTick: { show: false },
            splitLine: { show: false },
        },
    ],
    ...
    series: [
        ...
        },
        {
            ...
            data: derivData,
            showSymbol: false,
            lineStyle: { color: t.palette[2], width: 2.5, opacity: 0.85 },
            itemStyle: { color: t.palette[2] },
            areaStyle: { color: t.palette[2], opacity: 0.08 },
        },
    ],
});
