...
ALLOWED_ORIGINS = ["https://anyplot.ai", "http://localhost:3000"]
...
SIZE_REPORTER_SCRIPT = get_size_reporter_script("https://anyplot.ai")

# Allowed GCS bucket for security
ALLOWED_HOST = "storage.googleapis.com"
ALLOWED_BUCKET = "anyplot-images"
...
def _trusted_gcs_content(content: str) -> str:
    ...
    Content passed here MUST come from our controlled GCS bucket (anyplot-images)
    ...
    Security guarantees:
    - URL is validated to only allow storage.googleapis.com/anyplot-images/*
...
async def proxy_html(url: str, origin: str | None = None):
    ...
    target_origin = "https://anyplot.ai"
    ...
    # Security: Content is fetched from our controlled GCS bucket (anyplot-images),
    ...
    return HTMLResponse(
        # Suppress CodeQL false positive: content is from our controlled GCS bucket (anyplot-images),
