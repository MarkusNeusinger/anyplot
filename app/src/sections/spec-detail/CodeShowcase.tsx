      ...
      >
        ...
        <Box>
          ...
          >
            ...
            losing your color grammar — a <em style={{ fontStyle: 'italic' }}>gentoo penguin</em> is
        ...
        >
          <Box component="pre" sx={{ mt: 3, m: 0, whiteSpace: 'pre' }}>
            ...
            <Box component="span" sx={{ color: '#2ABCCD' }}>
              import
            </Box>
            {' anyplot '}
            <Box component="span" sx={{ color: '#2ABCCD' }}>
            ...
            {' ap\n\n'}
            {'data = ap.'}
            <Box component="span" sx={{ color: '#99B314' }}>
              load
            </Box>
            {'('}
            <Box component="span" sx={{ color: '#DDCC77' }}>
              "penguins"
            </Box>
            {')\n\n'}
            <Box component="span" sx={{ color: '#666', fontStyle: 'italic' }}>
