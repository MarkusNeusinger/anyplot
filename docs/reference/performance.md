...
| Cloud Run (frontend) | 1 vCPU, 512Mi RAM, min-instances=0, max-instances=1, concurrency 80 | nginx serving SPA; scales to zero since 2026-08-29, crawler traffic keeps the instance alive; capped at one instance since 2026-09-11 (see `app/cloudbuild.yaml`) |
